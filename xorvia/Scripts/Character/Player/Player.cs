...
public class Player : Character
    {
        ...
        private void CharacterCreationBonuses(PlayerSetting[] characterInfo)
        {
        ...
        public Player(PlayerSetting[] characterInfo)
        {
            ...
            {
                CharacterCreationBonuses(characterInfo);
            }

            // Battle attributes like health, dmg reduction, etc..
            CombatStats = new CombatStatList(Stats, CharacterInfo[1].MainStat);
