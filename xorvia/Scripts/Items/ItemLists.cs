...
public class FoodItemList : ItemList
    ...
    public class OreItemList : ItemList
    {
        public OreItemList()
        {
            List = new List<Item>
            {
                new Ore("Copper ore", "", 5,15, Rarity.Common),
                new Ore("Tin ore", "",10, 20, Rarity.Common),
                new Ore("Iron ore", "",15, 30, Rarity.Uncommon),
                new Ore("Gold ore", "",20,40, Rarity.Uncommon),
                new Ore("Mithril ore", "",25, 45, Rarity.Rare),
            };
        }
    ...
    public class MaterialItemList : ItemList
    {
        public MaterialItemList()
        {
            List = new List<Item>
            {
                ...
                new Material("Copper bar","For making copper weapons and armor",5, Rarity.Common)
                // iron bar...
                // herbs maybe??
            };
        }
    ...
    public class WeaponItemList : ItemList
    {
        ...
        public WeaponItemList()
        {
            List = new List<Item>
            {
                new Weapon( 0, GearSlot.MainHand, "Melee", "Copper dagger",150, "pretty dull dagger",
                    new List<AttBonus>()
                    {
                        new AttBonus("Strength", 4, "points"),
                    }, Rarity.Common),
                new Weapon(0, GearSlot.MainHand, "Magic", "Copper staff",150, "pretty bad staff",
                    new List<AttBonus>()
                    {
                        new AttBonus("Intellect", 4, "points"),
                    }, Rarity.Common),
                new Weapon(0, GearSlot.OffHand, "Magic", "Copper bow",150, "pretty bad bow",
                    new List<AttBonus>()
                    {
                        new AttBonus("Agility", 4, "points"),
                    }, Rarity.Common),
            };
        }
